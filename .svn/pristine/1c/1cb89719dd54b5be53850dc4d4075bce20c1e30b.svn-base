...
public  String SendGet(String url, String param) {
        ...
        try {
            if(param.isEmpty()==false){url=url + "?" + param;}
...
public  String sendPost(String url, String param) {
     ...
     * @param in
     */
    public static void Expetion(BufferedReader in){
    try{
        if(in!=null){
            in.close();
        }
